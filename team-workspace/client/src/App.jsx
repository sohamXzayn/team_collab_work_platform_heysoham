...
function Dashboard() {
  ...
  // Handle task status progression directly on dashboard
    ...
    <div className="grid-dash-layout">
      ...
      <main className="dashboard-main-panel">
        <header className="dash-header">
          <div>
            <span className="text-xs font-semibold text-indigo uppercase tracking-wider">WORKSPACE STREAM</span>
        ...
        <div className="dash-banner">
          <h2 className="dash-banner-title">Team Collaboration Hub</h2>
        ...
        <section className="grid-metrics">
          ...
          <div className="stats-card-premium">
            ...
            <span className="text-xs text-gray-muted mt-1.5">Approved team members</span>
          </div>
          ...
          <div className="stats-card-premium">
            ...
            <span className="text-xs text-gray-muted mt-1.5">Discussions rooms</span>
          </div>
        </section>
